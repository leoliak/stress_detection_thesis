# -*- coding: utf-8 -*-
"""
Created on Fri Sep 27 19:13:16 2019
...
rf_cl = RandomForestClassifier(n_estimators=700, max_depth=45)
...
print('10-fold Score for SVM:', round(100*scores_svm.mean(),4),'%')
print('10-fold Score for RF:',round(100*scores_rf.mean(),4),'%')
print('10-fold Score for KNN:',round(100*scores_knn.mean(),4),'%')
...
print('\n')
print('Test Score for SVM:', round(100*a_svm,4),'%')
print('Test Score for RF:',round(100*a_rf,4),'%')
print('Test Score for KNN:',round(100*a_knn,4),'%')
...
svm_cl = SVC(kernel='rbf', C=2.61, gamma=0.01, probability=True)
rf_cl = RandomForestClassifier(n_estimators=600, max_depth=25)
...
svm_cl = SVC(kernel='rbf', C=2.21, gamma=0.1, probability=True)
rf_cl = RandomForestClassifier(n_estimators=600, max_depth=25)
...
df_time = pd.read_csv('baseline_datasets/full_feature_dataset.csv')
voc = {"Condition": {"N":1, "S":2}}
df_t = df_time
df_t.replace(voc, inplace=True)
...
svm_cl = SVC(kernel='rbf', C=2.71, gamma=0.01, probability=True)
