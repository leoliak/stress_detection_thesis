...
def results_custom(clf_rf, clf_svm, clf_knn, y_test, exp_name, X_test):  
    # list1, list2 = rmv_non_important_features(clf_rf, feats)
...
if __name__ == "__main__":
    ...
    list_baseline = ['baseline_datasets/part_out/physio_baselinne_data.csv', 'baseline_datasets/kinect_baseline_data.csv', 'baseline_datasets/face_baseline_data.csv', 'baseline_datasets/full_feature_baseline_dataset.csv']
    ...
    results_custom(clf_rf_physio, clf_svm_physio, clf_knn_physio, y_test, "Physio", X_test)
    ...
    print("Train data: {}".format(X_tr.shape[0]))
    print("Test data: {}".format(X_test.shape[0]))
    results_custom(clf_rf_kinect, clf_svm_kinect, clf_knn_kinect, y_test, "Kinect", X_test)
    ...
    print("Train data: {}".format(X_tr.shape[0]))
    print("Test data: {}".format(X_test.shape[0]))
    results_custom(clf_rf_face, clf_svm_face, clf_knn_face, y_test, "Face", X_test)
 ...
 #####################################################################
    ...
    print("Train data: {}".format(X_tr.shape[0]))
    print("Test data: {}".format(X_test.shape[0]))
    results_custom(clf_rf, clf_svm, clf_knn, y_test, "Fusion", X_test)
